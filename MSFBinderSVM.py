...
def MSFBinderSVM():
    ...
    feature_acstructquan = np.loadtxt(open("E:/DNAbindingprotein/g_feature_gai1221_structual_guiyihua.csv"),
                                        delimiter=",", skiprows=0)
    label_acstructquan = np.loadtxt(open("E:/DNAbindingprotein/g_label_CT_1211.csv"), delimiter=",",
                                      skiprows=0)
